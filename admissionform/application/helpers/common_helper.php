...
function sendEmail($to,$from,$subject,$message)
{
    ...
    try {
        ...
        $headers .= "From: info.driitian@gmail.com <". $from .">\r\n"; 

        $headers .= "Organization: DR IITIAN \r\n";
...
function send_smtp_mail($to, $from, $subject,$pathToUploadedFile,$message)
{
	...
	$mail->Host = 'sg3plcpnl0100.prod.sin3.secureserver.net';                    // Specify main and backup SMTP servers
	$mail->SMTPAuth = true;                            // Enable SMTP authentication
	$mail->Username = 'info@driitian.com';  // SMTP username
	$mail->Password = 'Driitiann@753#'; // SMTP password
	$mail->SMTPSecure = 'ssl';                         // Enable TLS encryption, `ssl` also accepted
	$mail->Port = 465;                                 // TCP port to connect to

	$mail->setFrom($from, 'Driitian');
	$mail->addReplyTo($to, 'Driitian');
	$mail->addAddress($to);
...
function shortdescription($description,$size=100)
...
function blogshortdescription($description,$size)
