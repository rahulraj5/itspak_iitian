...
<div class="container-fluid">
	...
	<div class="panel panel-headline">
		...
		<div class="panel-heading">
			...
			<h3 class="panel-title"> Blog List <a href="<?php echo base_url() ?>admin/addblog/" class="btn pull-right btn-primary">Add Blog</a></h3>
		...
		<div class="panel-body table-responsive">
			...
			<table class="table table-hover" id="user_list_tab">
				...
				<tbody>
					...
					<?php if(!empty($postbloglist)){ ?>

					<?php $sn = 1; foreach($postbloglist as $ul){ ?>
					...
					<tr>
						...
						<td><a href="<?php echo (!empty($ul['image'])?  base_url().'uploads/blogimage/'.$ul['image']:DEFULT_USER_IMG); ?>" class="image-link"><img src="<?php echo (!empty($ul['image'])? base_url().'uploads/blogimage/'.$ul['image']:DEFULT_USER_IMG); ?>" class="user_image"></a></td>
						...
						<td>
							...
							<a href="<?php echo base_url() ?>admin/addblog/<?php echo $ul['id']; ?>" title="Edit Blog"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
                            ...
                            <a href="javascript:void(0)" href-status="3" href-role="2" href-id="<?php echo $ul['id']?>" href-act="deleteRecord" class="btn_delete" title="Delete Blog"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
...
<script type="text/javascript">
    ...
    $('.btn_delete').click(function(){
        ...
        $.ajax({
            ...
            data:{id:id,table:'addblog',colwhr:'id'},
