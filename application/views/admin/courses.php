...
<div class="container-fluid">
	<div class="panel panel-headline">
		<div class="panel-heading">
			<h3 class="panel-title"> Course List <a href="<?php echo base_url() ?>admin/addcourses/" class="btn pull-right btn-primary">Add Course</a></h3>
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							&nbsp;
							<a href="<?php echo base_url() ?>admin/addcourses/<?php echo $ul['id']; ?>" title="Edit Facility">
...
<script type="text/javascript">
    ...
    $('.btn_delete').click(function(){
        ...
        $.ajax({
            ...
            data:{id:id,table:'Courses',colwhr:'id'},
            dataType: 'json',
