...
<div class="container-fluid">
	<div class="panel panel-headline">
		<div class="panel-heading">
			<h3 class="panel-title"> Slider Image List <a href="<?php echo base_url() ?>admin/add_slider_image/" class="btn pull-right btn-primary">Add Slider</a></h3>
		...
		<div class="panel-body table-responsive">
			<table class="table table-hover" id="user_list_tab">
				...
				<tbody>
					<?php if(!empty($postsliderimage)){ ?>
					<?php $sn = 1; foreach($postsliderimage as $ul){ ?>
					<tr>
						<td><?php echo $sn; ?></td>
						<td><a href="<?php echo (!empty($ul['image'])?  base_url().'uploads/sliderimage/'.$ul['image']:DEFULT_USER_IMG); ?>" class="image-link"><img src="<?php echo (!empty($ul['image'])? base_url().'uploads/sliderimage/'.$ul['image']:DEFULT_USER_IMG); ?>" class="user_image"></a></td>
						<!-- <td> -->
						...
						<td>
							...
							&nbsp;
							<a href="<?php echo base_url() ?>admin/add_slider_image/<?php echo $ul['id']; ?>" title="Edit Slider"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
							&nbsp;
							<!-- <?php if($ul['status'] == 1){ ?>
                            ...
                            <a href="javascript:void(0)" href-status="3" href-role="2" href-id="<?php echo $ul['id']?>" href-act="deleteRecord" class="btn_delete" title="Delete Slider"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
						</td>
					</tr>
					<?php $sn++; } }else{ ?>
					<tr>
...
<script type="text/javascript">
    ...
    $('.btn_delete').click(function(){
        ...
        $.ajax({
            ...
            data:{id:id,table:'slider_image',colwhr:'id'},
            dataType: 'json',
